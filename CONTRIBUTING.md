...
issue](https://github.com/cisagov/setup-go-package/issues) in this
...
request](https://github.com/cisagov/setup-go-package/pulls), you will
...
```console
cd setup-go-package
pyenv virtualenv <python_version_to_use> setup-go-package
pyenv local setup-go-package
